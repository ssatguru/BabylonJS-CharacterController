...
It uses the collider and moveWithCollision() function to move the character around. It uses some of the physics kinematic equations to calculate some of movements like jump, fall, slide. It doesnot use any physics engine. It doesnot react to forces or apply forces. 
